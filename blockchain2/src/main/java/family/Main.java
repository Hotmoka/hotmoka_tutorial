 ...
 * 
 * mvn clean package
 * java --module-path ../../hotmoka/modules/explicit/:../../hotmoka/modules/automatic:target/blockchain2-0.0.1-SNAPSHOT.jar -classpath ../../hotmoka/modules/unnamed"/*" --module blockchain/family.Main
 */
public class Main {
