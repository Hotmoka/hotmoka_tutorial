 ...
 * 
 * mvn clean package
 * java --module-path ../../hotmoka/modules/explicit/:../../hotmoka/modules/automatic:target/blockchain5-0.0.1-SNAPSHOT.jar -classpath ../../hotmoka/modules/unnamed"/*" --module blockchain/auction.Main
 */
public class Main {
	...
	private Main(Node node) throws Exception {
		this.node = node;
